...
void AddCustomScripts()
{
	...
	AddSC_Duel_Reset();
	AddSC_npc_changer();
	AddSC_Honorable_Kills_Shop();
	AddSC_honorable_kills_shopone();
	AddSC_honorable_kills_shoptwo();
	AddSC_buff_npc();
	AddSC_npc_MiniTeleporter();
	AddSC_item_race();
	AddSC_npc_info();
	AddSC_vipcommands();
