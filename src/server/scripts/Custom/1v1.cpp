...
#define ARENA_1V1_MIN_LEVEL 85 // min level to create an arenateam
...
public:
	...
	bool JoinQueueArena(Player* player, Creature* me)
	{
		...
		uint8 arenatype = ARENA_TEAM_5v5;
	...
	bool CreateArenateam(Player* player, Creature* me)
	{
		...
		if (!arenaTeam->Create(player->GetGUID(), ARENA_TEAM_5v5, teamName.str(), 0, 0, 0, 0, 0))
		{
			delete arenaTeam;
			return false;
		}
	...
	bool OnGossipHello(Player* player, Creature* me)
	{
		...
		else
		{
			if(player->InBattlegroundQueueForBattlegroundQueueType(BATTLEGROUND_QUEUE_5v5))
				player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface/ICONS/Achievement_Arena_3v3_5:30|t Leave 1v1 Arena", GOSSIP_SENDER_MAIN, 3);
			else
			{
