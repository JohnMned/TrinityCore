...
public:
	...
	bool OnGossipHello(Player* player, Creature* creature)
	{
		...
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\Ability_Hunter_BeastTaming:25|tObtain a New Pet", GOSSIP_SENDER_MAIN, 30);
		if (player->CanTameExoticPets())
			player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\ABILITY_SEAL:25|tObtain a New Exotic Pet", GOSSIP_SENDER_MAIN, 50);
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "|TInterface\\icons\\Mail_GMIcon:25|tNevermind!", GOSSIP_SENDER_MAIN, 150);
