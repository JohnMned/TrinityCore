...
//------------------------------Menus------------------------------//
                ...
                case GOSSIP_ACTION_INFO_DEF+1:// teleport service
                        ...
                        {
                        plr->ADD_GOSSIP_ITEM(2, "Malls", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+6);
                ...
                case GOSSIP_ACTION_INFO_DEF+6: //mall and event
                        plr->ADD_GOSSIP_ITEM(2, "Mall PVE", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+21); 
                        plr->ADD_GOSSIP_ITEM(2, "Mall PVP", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+151); 						
              ...
              //  case GOSSIP_ACTION_INFO_DEF+14: // GM Island Teleport
				//	if(plr->HasItemCount(12064, 1))
					//    {
					   ...
					   // }
                       // break;
                case GOSSIP_ACTION_INFO_DEF+21: //mall teleport PVE
                        plr->TeleportTo(530, 281.041748f, 5999.461426f, 144.730270f, 1.598671f);
                        break;
				case GOSSIP_ACTION_INFO_DEF+151: //mall teleport PVP
                        plr->TeleportTo(1, -7120.85f, -3792.18f, 8.39965f, 3.02425f);
                        break;		
